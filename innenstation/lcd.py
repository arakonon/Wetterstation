...
class LcdControl:
    ...
    def display_measurement(self, temperature, humidity, iaq_str, eco2_str, eco2):
        ...
        self.display_text(f" {temperature:.1f}°C  {humidity:.1f}%rF",
                    iaq_str + "      " + eco2_str)
        ppm_placement = 14 if not isinstance(eco2, int) else (14 if eco2 > 999 else 13 if eco2 > 99 else 12) # Für den Ort, an dem das Symbol "ppm" auf dem LCD angezeigt wird.
